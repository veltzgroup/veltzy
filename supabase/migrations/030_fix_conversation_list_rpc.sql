-- Fix: RPC get_conversation_list referencia coluna is_internal que foi removida na migration 029
-- Isso quebrava o inbox inteiro (lista de conversas vazia, mensagens nao carregam)
